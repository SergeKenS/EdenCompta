...
public class CashSessionDto {
    ...
    public CashSessionDto(UUID id, UUID storeId, String userId, LocalDateTime openedAt, LocalDateTime closedAt,
    ...
    public static CashSessionDto fromEntity(CashSession session) {
