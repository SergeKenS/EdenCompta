...
public class OtherSessionDto {
    ...
    public OtherSessionDto() {}

    public OtherSessionDto(UUID id, UUID storeId, String userId, LocalDateTime openedAt, LocalDateTime closedAt,
    ...
    public static OtherSessionDto fromEntity(OtherSession session) {
        return new OtherSessionDto(
                session.getId(),
